...
function Footer() {
  return (
    <footer className=" bg-palette-100 px-4 py-8 flex flex-col justify-center items-center gap-6">
      <Logo />
      ...
      <p className="text-sm text-palette-500">© Copyright 2023 Jhonata Polito. All rights reserved.</p>
    </footer>
  );
}
