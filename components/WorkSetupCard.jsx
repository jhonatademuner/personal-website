...
function WorkSetupCard() {
  return (
    <div className="flex flex-col lg:flex-row box-border w-[360px] lg:w-[48rem] rounded-2xl overflow-hidden bg-primary bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-10 shadow-[0_6px_15px_rgba(100,100,197,0.1)]">
      <div className="flex lg:flex-col w-full items-center justify-center text-xl gap-2 text-text bg-secondary bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-70 p-4 shrink-0 lg:w-32">
      ...
      <div className="flex flex-col lg:flex-row w-full h-full justify-between items-center gap-8 py-4 lg:px-4">
        <div className="flex flex-col h-full lg:w-1/2 gap-2 whitespace-nowrap">
        ...
        <div className="flex flex-col h-full lg:w-1/2 whitespace-nowrap gap-2">
          <div className="flex text-primary gap-2 items-center mb-4">
            <span className="text-4xl">
              <FaKeyboard />
            </span>
